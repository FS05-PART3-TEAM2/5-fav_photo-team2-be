...
exports.toMarketMeResponse = exports.toMarketResponse = void 0;
...
const toMarketMeResponse = (card) => {
    const offer = card.saleCard
        ...
        : card.exchangeOffer
            ...
            : null;
    if (!offer)
        throw new Error("Invalid MarketOfferDto: Missing saleCard or exchangeOffer");
    return {
        saleCardId: card.id,
        status: offer.status,
...
exports.toMarketMeResponse = toMarketMeResponse;
